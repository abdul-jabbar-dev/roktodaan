...
export default function Page() {
    ...
    return (
        <div className="container mx-auto my-5 p-5 relative">
                    ...
                    <div className="bg-white p-3 border-t-4 border-red-400">
                        ...
                        <h1 className="text-gray-900 font-bold text-xl leading-8 my-1">
                            {CDInputToText({
                                ...
                                edit,
                                name: 'fullName',
                                onChange: e => setUser(prev => ({ ...prev, profile: { ...prev.profile, fullName: e.target.value } })),
                            })}
                        </h1>
                        <h3 className="text-gray-600 font-lg text-semibold leading-6">
                            {CDInputToText({
                                ...
                                edit,
                                name: 'occupation',
                                onChange: e => setUser(prev => ({ ...prev, profile: { ...prev.profile, occupation: e.target.value } })),
                            })}
                        </h3>
                    </div>
            ...
            {message && (
                <p className={`mt-3 w-full text-center fixed bottom-[60px] text-sm transition-opacity duration-500 ${message.type === 'success' ? 'text-green-600' : 'text-red-500'}`}>
                    {message.text}
                </p>
            )}
        </div>
