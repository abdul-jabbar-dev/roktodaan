...
export default function TopNotify() {
  ...
  // initial state directly path অনুযায়ী set করা হলো
  ...
  return (
    <div className="relative isolate flex items-center gap-x-6 overflow-hidden bg-red-400 px-6 py-2.5 after:pointer-events-none after:absolute after:inset-x-0 after:bottom-0 after:h-px after:bg-white/10 sm:px-3.5 sm:before:flex-1">
      <div
        aria-hidden="true"
      ...
      <div className="flex flex-1 justify-end">
        <button
          ...
          type="button"
          className="cursor-pointer -m-3 p-3 focus-visible:-outline-offset-4"
        >
